...
?>
    ...
    <section style="
    background: url(admin/Uploads/images/63870_tasty-coffee-espresso-small-cup-near-window-home-concept-top-view-toning.jpg);
...
">Reservar uma mesa</h1>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="reservation_date">Dia</label>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="reservation_time">Horário</label>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="number_of_guests">Quantidade de Pessoas</label>
                            <select class="form-control" name="number_of_guests">
                                <option value="1" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Uma pessoa</option>
                                <option value="2" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Duas pessoas</option>
                                <option value="3" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Tres pessoas</option>
                                <option value="4" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Quatro pessoas</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="check_availability" style="visibility: hidden;">Checar Disponibilidade</label>
            ...
            <?php
                ...
                if(isset($_POST['check_availability_submit']))
                {
                    ...
                    if($stmt->rowCount() == 0)
                    {
                        ?>
                            <div class="error_div">
                                <span class="error_message" style="font-size: 16px">Todas as mesas estão esgotadas neste horário</span>
                            </div>
                        <?php
                    }
                    else
                            ...
                            <form method="POST" action="table-reservation.php">
                                ...
                                <div class="client_details_tab">
                                    <div class="form-group colum-row row">
                                        <div class="col-sm-12">
                                            <input type="text" name="client_full_name" id="client_full_name" oninput="document.getElementById('required_fname').style.display = 'none'" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" class="form-control" placeholder="Nome Completo">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text"  name="client_phone_number" id="client_phone_number" oninput="document.getElementById('required_phone').style.display = 'none'" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="Numero de celular">
                                ...
                                <div class="form-group">
                                    <input type="submit" name="submit_table_reservation_form" class="btn btn-info" value="Fazer a reserva">
                                </div>
                            </form>
                        <?php
                    }
    ...
    <section class="restaurant_details" style="background: url(admin/Uploads/images/63870_tasty-coffee-espresso-small-cup-near-window-home-concept-top-view-toning.jpg);
    background-repeat: no-repeat;
