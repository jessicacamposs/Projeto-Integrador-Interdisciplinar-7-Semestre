                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Adicionar Uma Nova Imagem</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="image_name">Nome da Imagem</label>
                                    <input type="text" id="image_name_input" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="Nome da Imagem" name="image_name">
                                    <div id = 'required_image_name' class="invalid-feedback">
                                        <div>O nome da imagem e obrigatorio!</div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-info" id="add_image_bttn">Adicionar Imagem</button>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <li class="list-inline-item" data-toggle="tooltip" title="Deletar">
                                                    ...
                                                    <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Deletar Imagem</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    Voce quer deletar a imagem atual?
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                                    <button type="button" data-id = "<?php echo $image['image_id']; ?>" class="btn btn-danger delete_image_bttn">Deletar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
