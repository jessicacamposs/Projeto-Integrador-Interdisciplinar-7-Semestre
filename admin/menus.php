                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered menus-table">
                            <thead>
                                <tr>
                                    <th scope="col">Nome do Menu</th>
                                    <th scope="col">Categoria do Menu</th>
                                                ...
                                                /****/
                                                    ...
                                                    ?>
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Visualizar">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Deletar">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Deletar Menu</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                Voce tem certeza que quer deletar este menu "<?php echo strtoupper($menu['menu_name']); ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                                                <button type="button" data-id = "<?php echo $menu['menu_id']; ?>" class="btn btn-danger delete_menu_bttn">Deletar</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="panel-X">
                                    ...
                                    <div class="save-header-X">
                                        <div style="display:flex">
                                            ...
                                            <div class="title-container">Menu detalhes</div>
                                        </div>
                                        <div class="button-controls">
                                            <button type="submit" name="add_new_menu" class="btn btn-primary">Salvar</button>
                                        </div>
                                    </div>
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            <label for="menu_name">Menu Nome</label>
                                            <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_name']))?htmlspecialchars($_POST['menu_name']):'' ?>" placeholder="Menu Nome" name="menu_name">
                                            <?php
                                                    ...
                                                    if(empty(test_input($_POST['menu_name'])))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Um Nome Para o Menu e Obrigatorio.
                                                            </div>
                                                        <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label for="menu_category">Categoria do Menu</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_description">Descricao do Menu</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']))
                                                {
                                                    if(empty(test_input($_POST['menu_description'])))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Uma Descricao Para o Menu e Obrigatoria
                                                            </div>
                                                        <?php
                                                    ...
                                                    elseif(strlen(test_input($_POST['menu_description'])) > 200)
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                A descricao do menu deve ser menor que 200 caracteres
                                                            </div>
                                                        <?php
                                        ...
                                        <div class="form-group">
                                            <label for="menu_price">Precos(R$)</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['menu_price']))?htmlspecialchars($_POST['menu_price']):'' ?>" placeholder="Precos" name="menu_price">
                                            <?php
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST')
                                                {
                                                    ...
                                                    if(!empty($_FILES['menu_image']['name']) && !in_array($image_extension,$image_allowed_extension))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                Imagem em formato invalido! Apenas JPG, PNG e JPEG sao formatos aceitos
                                                            </div>
                                                        <?php
                ...
                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_menu_form == 0)
                {
                    ...
                    try
                    {
                        ...
                        ?> 
                            ...
                            <script type="text/javascript">
                                swal("Novo Menu","O novo menu foi criado com sucesso", "Sucesso").then((value) => 
                                {
                                    ...
                                    <div class="panel-X">
                                        ...
                                        <div class="save-header-X">
                                            <div style="display:flex">
                                                ...
                                                <div class="title-container">Detalhes do Menu</div>
                                            </div>
                                            <div class="button-controls">
                                                <button type="submit" name="edit_menu_sbmt" class="btn btn-primary">Salvar</button>
                                            </div>
                                        </div>
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_name'] ?>" placeholder="Nome do Menu" name="menu_name">
                                                <?php
                                                    ...
                                                    if(isset($_POST['edit_menu_sbmt']))
                                                    {
                                                        if(empty(test_input($_POST['menu_name'])))
                                                        {
                                                            ?>
                                                                <div class="invalid-feedback" style="display: block;">
                                                                    Nome para o menu e obrigatorio.
                                                                </div>
                                                            <?php
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($_POST['edit_menu_sbmt']))
                                                    {
                                                        ...
                                                        elseif(strlen(test_input($_POST['menu_description'])) > 200)
                                                        {
                                                            ?>
                                                                <div class="invalid-feedback" style="display: block;">
                                                                    O tamanho da descricao deve ser menor que 200 palavras
                                                                </div>
                                                            <?php
                                            ...
                                            <div class="form-group">
                                                <label for="menu_price">Preco(R$)</label>
                                                <input type="text" class="form-control" value="<?php echo $menu['menu_price'] ?>" placeholder="Preco" name="menu_price">
                                                <?php
                            ...
                            if(empty($_FILES['menu_image']['name']))
                            {
                                try
                                {
                                    ...
                                    ?> 
                                        ...
                                        <script type="text/javascript">
                                            swal("Editar Menu","O Menu Foi Atualizado Com Sucesso!", "Sucesso").then((value) => 
                                            {
                                                window.location.replace("menus.php");
                                            });
                                        </script>
...
<script type="text/javascript">
    ...
    $('.delete_menu_bttn').click(function()
    {
        ...
        $.ajax(
        {
            ...
            {
                swal("Deletar Menu","O menu foi deletado com sucesso", "Sucesso").then((value) => {
                    window.location.replace("menus.php");
                });     
            },
