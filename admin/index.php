	...
	<div class="login">
		<form class="login-container validate-form" name="login-form" action="index.php" method="POST" onsubmit="return validateLoginForm()">
					...
					else
					{
						?>
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>Usuario e/ou senha incorretos!</div>
								</div>
							</div>
						<?php 
					}
			...
			<div class="form-input">
				...
				<div class="invalid-feedback" id="username_required">Usuario e obrigatorio</div>
			</div>
			...
			<div class="form-input">
				...
				<div class="invalid-feedback" id="password_required">Senha e obrigatoria</div>
			</div>
