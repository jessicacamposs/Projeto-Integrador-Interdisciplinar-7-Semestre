                                    ...
                                    <div class="panel-X">
                                        ...
                                        <div class="save-header-X">
                                            <div style="display:flex">
                                                ...
                                                <div class="title-container">Detalhes do Usuario</div>
                                            </div>
                                            <div class="button-controls">
                                                <button type="submit" name="edit_user_sbmt" class="btn btn-primary">Salvar</button>
                                            </div>
                                        </div>
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $user['username'] ?>" placeholder="Usuario" name="user_name">
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $user['full_name'] ?>" placeholder="Nome Completo" name="full_name">
                                                <?php
                                                    if(isset($_POST['edit_user_sbmt']))
                                                    {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" value="<?php echo $user['email'] ?>" placeholder="Email" name="user_email">
                                                <?php
                            ...
                            if(empty($user_password))
                            {
                                try
                                {
                                    ...
                                    ?> 
                                        ...
                                        <script type="text/javascript">
                                            swal("Editar Usuario","Usuario foi modificado com sucesso", "Sucesso").then((value) => 
                                            {
