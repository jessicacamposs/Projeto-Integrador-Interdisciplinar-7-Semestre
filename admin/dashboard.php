    	...
    	?>
            ...
            <div class="card" style = "margin: 20px 10px">
                ...
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_orders active" onclick="openTab(event, 'recent_orders','tabcontent_orders','tablinks_orders')">Pedidos Recentes</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'completed_orders','tabcontent_orders','tablinks_orders')">Pedidos Concluidos</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'canceled_orders','tabcontent_orders','tablinks_orders')">Pedidos Cancelados</button>
                </div>
                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista de Pedidos Recentes";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title">Detalhes Clientes</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <ul>
                                                                            <li><span style="font-weight: bold;">Nome Completo </span> <?php echo $order['client_name']; ?></li>
                                                                            <li><span style="font-weight: bold;">Telefone: </span><?php echo $order['client_phone']; ?></li>
                                                        ...
                                                        <li class="list-inline-item" data-toggle="tooltip" title="Deliver Order">
                                                            ...
                                                            <div class="modal fade" id="<?php echo $deliver_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $deliver_data; ?>" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Ordem de Entrega</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            Marcar como Entrega Concluida?
                                                                        </div>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                <label>Razao do Cancelamento</label>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista de pedidos concluidos";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista de pedidos cancelados";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
            ...
            <div class="card" style = "margin: 20px 10px">
                ...
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_reservations active" onclick="openTab(event, 'recent_reservations','tabcontent_reservations','tablinks_reservations')">Reservas Recentes</button>
                    <button class="tablinks_reservations" onclick="openTab(event, 'completed_reservations','tabcontent_reservations','tablinks_reservations')">Reservas Concluidas</button>
                    <button class="tablinks_reservations" onclick="openTab(event, 'canceled_reservations','tabcontent_reservations','tablinks_reservations')">Reservas Canceladas</button>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista de proximas reservas";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    if($count == 0)
                                    {
                                        ...
                                        echo "<tr>";
                                            echo "<td colspan='5' style='text-align:center;'>";
                                                echo "Lista de reservas concluidas";
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    else
    ...
    $('.deliver_order_button').click(function()
    {
        ...
        $.ajax({
            ...
            success: function (data) 
            {
                ...
                swal("Pedido Entregue","O Pedido Foi Marcado Como Entregue", "Sucesso").then((value) => 
                {
    ...
    $('.cancel_order_button').click(function()
    {
        ...
        $.ajax(
        {
            ...
            success: function (data) 
            {
                ...
                swal("Pedido Cancelado","O pedido foi cancelado", "sucesso").then((value) => 
                {
                    window.location.replace("dashboard.php");
                });
            },
