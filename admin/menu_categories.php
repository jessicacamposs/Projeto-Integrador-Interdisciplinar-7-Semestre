                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Adicionar uma nova categoria</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="category_name_input" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="Nome da categoria" name="category_name">
                                        <div id = 'required_category_name' class="invalid-feedback">
                                            <div>Nome da categoria e obrigatorio!</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                    <button type="button" class="btn btn-info" id="add_category_bttn">Adicionar Categoria</button>
                                </div>
                            </div>
                        </div>
                    </div>
		                                                    ...
		                                                    <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
		                                                        <div class="modal-dialog" role="document">
		                                                            <div class="modal-content">
		                                                                ...
		                                                                <div class="modal-body">
		                                                                    Voce tem certeza que deseja deletar esta categoria "<?php echo strtoupper($category['category_name']); ?>"?
		                                                                </div>
		                                                                <div class="modal-footer">
		                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
		                                                                    <button type="button" data-id = "<?php echo $category['category_id']; ?>" class="btn btn-danger delete_category_bttn">Deletar</button>
		                                                                </div>
		                                                            </div>
		                                                        </div>
		                                                    </div>
...
<script type="text/javascript">
	...
	// When Adicionar Categoria button is clicked
	...
	// When Deletar Categoria button is clicked
    ...
    $('.delete_category_bttn').click(function()
    {
        ...
        $.ajax(
        {
            ...
            success: function (data) 
            {
                swal("Deletar Categoria","A categoria foi deletada com sucesso!", "Sucesso").then((value) => {
                    window.location.replace("menu_categories.php");
                });     
            },
            error: function(xhr, status, error) 
