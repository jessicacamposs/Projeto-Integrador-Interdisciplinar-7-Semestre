		...
		<form method="post" id="order_food_form" action="order_food.php">
				                                    	...
				                                    	<div class="select_item_bttn">
				                                    		<div class="btn-group-toggle" data-toggle="buttons">
																<label class="menu_label item_label btn btn-secondary">
																	<input type="checkbox"  name="selected_menus[]" value="<?php echo $row['menu_id'] ?>" autocomplete="off">Selecionar
																</label>
															</div>
				                                    	</div>
				                                    <?php
            ...
            <div class="client_details_tab order_food_tab" id="clients_tab">
                ...
                <div>
                    ...
                    <div class="form-group colum-row row">
                        <div class="col-sm-12">
                            <input type="text" name="client_delivery_address" id="client_delivery_address" oninput="document.getElementById('required_delivery_address').style.display = 'none'" class="form-control" placeholder="Endereco de entrega">
            ...
            <div style="overflow:auto;padding: 30px;">
                <div style="float:right;">
                    ...
                    <button type="button" class="next_prev_buttons" style="background-color: #bbbbbb;"  id="prevBtn"  onclick="nextPrev(-1)">Anterior</button>
                    <button type="button" id="nextBtn" class="next_prev_buttons" onclick="nextPrev(1)">Proximo</button>
                </div>
            </div>
    ...
    <section class="widget_section" style="background-color: #222227;padding: 100px 0;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <h3>Se inscreva para receber as novidades!</h3>
