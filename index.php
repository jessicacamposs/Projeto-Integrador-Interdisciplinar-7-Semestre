...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						<h1>
							Expresso Gourmet Delivery
						</h1>
						<h2>
							Tradição ao seu alcance
						</h2>
						<hr>
						<p>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							Oferecem uma experiência sensorial única, 
							Ao moer os grãos no momento do preparo, 
							as notas aromáticas se preservam, 
							garantindo uma bebida mais intensa e rica.
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
							A solução ideal para quem busca praticidade e rapidez. 
							Com esse serviço, 
							você recebe seu pedido no conforto de casa, 
							sem perder tempo.
	                        </p>
	                    </div>
	                </div>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
							...
							promovemos a biodiversidade e 
							buscamos otimizar os recursos naturais de forma responsável. 
	                        </p>
	                    </div>
	                </div>
				</div>
	...
	<section class="our_menus" id="menus">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">Descubra os nossos menus</h2>
	...
	<section class="image-gallery" id="gallery">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">Galeria de imagens</h2>
			<?php
                    ...
                    <div class="contact-form">
                        <div id="contact_ajax_form" class="contactForm">
                            <div class="form-group colum-row row">
                                <div class="col-sm-6">
                                    <input type="text" id="contact_name" name="name" oninput="document.getElementById('invalid-name').innerHTML = ''" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" class="form-control" placeholder="Nome">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input type="text" id="contact_subject" name="subject" oninput="document.getElementById('invalid-subject').innerHTML = ''" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" class="form-control" placeholder="Assunto">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea id="contact_message" name="message" oninput="document.getElementById('invalid-message').innerHTML = ''" cols="30" rows="5" class="form-control message" placeholder="Mensagem"></textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button id="contact_send" class="bttn_style_2">Enviar Mensagem</button>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Endereço</h3>
                        <p> 123  Rua dos cafes, Taubate, SP, 3210456 - 891
                            <?php echo $restaurant_address; ?>
                        </p>
                        <p>
                            <?php echo $restaurant_email; ?>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Segunda - Sexta 11:30am - 2:008pm</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <h3>Se inscreva para receber as nossas novidades!</h3>
                        <div class="subscribe_form">
                            <form action="#" class="subscribe_form" novalidate="true">
                                <input type="email" name="EMAIL" id="subs-email" class="form_input" placeholder="Endereco de email...">
